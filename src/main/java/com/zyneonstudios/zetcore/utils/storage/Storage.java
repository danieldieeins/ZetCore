package com.zyneonstudios.zetcore.utils.storage;
    ...
    public void setupTable(String table, int contentSize) {
        if (type != storageType.YAML) {
            try {
                ...
                API.getCommunicator().sendConsoleError("§8=============================================================");
                API.getCommunicator().sendConsoleError("Couldn't connect to the " + type.toString() + "-Storage (" + table + ")...");
